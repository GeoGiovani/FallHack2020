...
var players = {
    1: Bodies.rectangle(150, 270, 50, 50, { isStatic: false }),
    2: Bodies.rectangle(400, 270, 50, 50, { isStatic: false })
}
...
//Main world add
World.add(world, [ground, players[1], players[2], bottomWall, topWall, rightWall, leftWall]);
